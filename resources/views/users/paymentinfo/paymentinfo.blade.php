...
<body>
    ...
    <div class="actions">
        <a href="{{ route('payment.create') }}" class="btn btn-light"><i class="fa-solid fa-cash-register"></i> New</a>
    </div>
        ...
        <tbody>
            @foreach ($paymentinfo as $payment)
                <tr>
                    ...
                    <td>{{ $payment->date }}</td>
                    <td>
                        <a href="{{ route('updatePayment', $payment->id) }}" class="btn btn-light" title="Update"><i class="fa-solid fa-pen"></i></a>
