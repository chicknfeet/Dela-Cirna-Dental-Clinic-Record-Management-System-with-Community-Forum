...
<body>
    ...
    <div class="actions">
        <a href="{{ route('patient.create') }}" class="btn btn-light"><i class="fa-solid fa-user-plus"></i> New</a>
        <input href="{{ route('patient.create') }}" class="form-control" type="search" placeholder="Search"  style="width: 10%;"></input>
    </div>
        ...
        <tbody>
            @foreach ($patientlist as $patient)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('showRecord', $patient->id) }}" class="btn btn-light" data-toggle="tooltip" title="Records"><i class="fa-solid fa-file-lines"></i></a>
                        <a href="{{ route('updatePatient', $patient->id) }}" class="btn btn-light" title="Update"><i class="fa-solid fa-pen"></i></a>
                        <form method="post" action="{{ route('deletePatient', $patient->id) }}" style="display: inline;">
                            @csrf
                            @method('DELETE')
